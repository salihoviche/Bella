...
import 'package:bella_client_mobile/providers/auth_provider.dart';
...
import 'package:bella_client_mobile/screens/register_screen.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<ManufacturerProvider>(create: (_) => ManufacturerProvider()),
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Color.lerp(const Color.fromARGB(255, 184, 102, 2), orangeDark, _colorSwapAnimation.value * 0.1)!,
                            Color.lerp(Colors.grey[800]!, orangePrimary, _colorSwapAnimation.value * 0.9)!,
                          ],
                        ),
                      ),
                    child: Stack(
                                        ...
                                        child: Transform.rotate(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              color: Colors.white,
                                              border: Border.all(
                                                color: orangePrimary.withOpacity(0.4 + _logoPulseAnimation.value * 0.2),
                                                width: 4,
                                              ),
                                              boxShadow: [
                                                BoxShadow(
                                                ...
                                                BoxShadow(
                                                  color: orangePrimary.withOpacity(0.3 * _logoPulseAnimation.value),
                                                  blurRadius: 25,
                                                  spreadRadius: 8,
                                                ),
                                              ],
