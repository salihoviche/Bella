...
class Review {
  ...
  String? get wellnessServiceImage {
    if (appointment?.hairstyleImage != null && appointment!.hairstyleImage!.isNotEmpty) {
      return appointment!.hairstyleImage;
    }
    if (appointment?.facialHairImage != null && appointment!.facialHairImage!.isNotEmpty) {
      return appointment!.facialHairImage;
    }
    // Dying doesn't have image, just color
    return null;
  }
