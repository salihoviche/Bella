  ...
  Widget build(BuildContext context) {
    return MasterScreen(
      ...
      child: SingleChildScrollView(
        ...
        child: _buildManufacturerDetails(context),
      ),
    );
  }

  Widget _buildManufacturerDetails(BuildContext context) {
    return Center(
      child: Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Manufacturer icon and basic info
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Manufacturer icon
          ...
          children: [
            ...
            Expanded(
              child: _buildInfoItem(
                ...
                label: 'Created At',
                value: _formatDate(manufacturer.createdAt),
                iconColor: Colors.blue,
              ),
            ),
          ],
        ),
        if (manufacturer.description != null && manufacturer.description!.isNotEmpty) ...[
          const SizedBox(height: 16),
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
