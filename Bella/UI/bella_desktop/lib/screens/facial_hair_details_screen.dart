...
class FacialHairDetailsScreen extends StatelessWidget {
  final FacialHair facialHair;

  const FacialHairDetailsScreen({super.key, required this.facialHair});
  ...
  Widget build(BuildContext context) {
    return MasterScreen(
      ...
      child: SingleChildScrollView(
        ...
        child: _buildFacialHairDetails(context),
      ),
    );
  }

  Widget _buildFacialHairDetails(BuildContext context) {
    return Center(
      child: Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Facial Hair image and basic info
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Facial Hair image
                        facialHair.image != null && facialHair.image!.isNotEmpty
                            ? BasePictureCover(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      facialHair.isActive ? 'Active' : 'Inactive',
                                      style: TextStyle(
                                        color: facialHair.isActive
                                            ? Colors.green[700]
                                            : Colors.red[700],
          ...
          children: [
            ...
            Expanded(
              child: _buildInfoItem(
                ...
                label: 'Price',
                value: '\$${facialHair.price.toStringAsFixed(2)}',
          ...
          children: [
            Expanded(
              child: _buildInfoItem(
                ...
                label: 'Created At',
                value: _formatDate(facialHair.createdAt),
            ...
            Expanded(
              child: _buildInfoItem(
                ...
                label: 'Status',
                value: facialHair.isActive ? 'Active' : 'Inactive',
                iconColor: facialHair.isActive ? Colors.green : Colors.red,
              ),
            ),
          ],
        ),
